 ...
 * @version     1.0
 */
class FloodAction extends HomeAction {
    /**
     * 共通设置顶部导航项目高亮显示
     */
...
//        $catIdArr = array('1' => 489, '2' => 490, '3' => 491, '4' => 492, '5' => 501, '6' => 494, '7'=>495 ,'8'=>528);
    ...
    public function view() {
        ...
        $question = D('Article')->where($where)->find();
        if (empty($question)) {
            $this->redirect("Public/404");
        }
