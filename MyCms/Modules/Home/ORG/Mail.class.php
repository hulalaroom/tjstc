    ...
    public function EncodeString($str, $encoding = 'base64') {
        ...
        switch (strtolower($encoding)) {
            ...
            case '7bit':case '8bit':$encoded = $this->FixEOL($str);
                if (substr($encoded, -(strlen($this->LE))) != $this->LE) $encoded.=$this->LE;break;
...
class SMTP {
    ...
    public function Connect($host, $port = 0, $tval = 30) {
        ...
        }if (substr(PHP_OS, 0, 3) != "WIN") socket_set_timeout($this->smtp_conn, $tval, 0);$announce = $this->get_lines();
        if ($this->do_debug >= 2) {
